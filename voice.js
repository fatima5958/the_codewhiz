/**
 * VOICE.JS — Web Speech API & Text-to-Speech Engine for Aria AI Assistant
 */
...
class AriaVoiceEngine {
    ...
    initVoiceSelection() {
        ...
        const updateVoices = () => {
            ...
            // Preferred female AI voice priority
            ...
            if (!this.selectedVoice) {
                ...
                this.selectedVoice = voices.find(v => v.lang.startsWith('en') && (v.name.includes('Female') || v.name.includes('Female'))) || voices[0];
            }
        };
    ...
    /**
     * Speak text using realistic TTS
     */
    speak(text, onStart, onEnd) {
        ...
        // Professional, calm, natural cadence settings
